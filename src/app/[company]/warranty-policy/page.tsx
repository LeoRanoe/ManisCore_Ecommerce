...
export default async function WarrantyPolicyPage({
  ...
  try {
    ...
    const breadcrumbItems = [
      ...
      { label: 'Warranty Policy', href: `/${params.company}/warranty-policy` },
    ];
            ...
            <div className="bg-card border border-border rounded-2xl p-8">
              {company.warrantyInfo ? (
                ...
                <div className="text-center py-12">
                  <p className="text-muted-foreground">
                    Warranty policy information is not available at this time.
                  </p>
                  <p className="text-sm text-muted-foreground mt-2">
                    Please contact us for product warranty details.
                  </p>
                </div>
              )}
            </div>
