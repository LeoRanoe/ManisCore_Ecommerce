      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            {/* Social Media */}
            {(company.socialMedia?.whatsapp || company.socialMedia?.instagram || company.socialMedia?.facebook) && (
              <div className="flex items-center gap-3 pt-2">
                {company.socialMedia?.whatsapp && (
                  <a
                    ...
                    className="w-10 h-10 rounded-lg bg-white/10 hover:bg-white text-gray-400 hover:text-black flex items-center justify-center transition-all"
                    aria-label="WhatsApp"
                  >
            ...
            <ul className="space-y-3 text-sm">
              {company.contactPhone && (
                <li className="flex items-start gap-3">
                  ...
                  <a href={`tel:${company.contactPhone}`} className="text-gray-400 hover:text-white transition-colors">
                    {company.contactPhone}
                  </a>
                </li>
              )}
              {company.contactEmail && (
                <li className="flex items-start gap-3">
                  ...
                  <a href={`mailto:${company.contactEmail}`} className="text-gray-400 hover:text-white transition-colors">
                    {company.contactEmail}
                  </a>
                </li>
              )}
